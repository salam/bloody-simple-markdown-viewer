...
public extension NSAttributedString.Key {
    ...
    /// When another program last changed this run, as a `Date`. Present only on
    /// lines edited while the document was open, and gone when it is reopened.
    static let changedAt = NSAttributedString.Key("MarkdownCore.changedAt")
